import { MemoProfileCard } from "../../Components/ProfileCard/ProfileCard";
...
export function DiscoverPage() {
    ...
    return (
        <div className={ DiscoverPageStyles.profiles }>
            {indexes.map((index) => {
                return (
                    <MemoProfileCard key={ fetchedUsers[index].user_id } user={ fetchedUsers[index] }profile={ fetchedProfiles[index] }/>
                )
            })}
        </div>
    )
